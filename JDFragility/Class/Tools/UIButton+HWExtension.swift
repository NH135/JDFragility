...
extension UIButton {
  ...
  public func addAction(events: UIControl.Event = .touchUpInside, block: @escaping()->Void) {
  ...
  ///   - events: 事件
  ///   - block: 回调
  public func addAction(events: UIControl.Event = .touchUpInside, block: @escaping(UIButton)->Void) {
