...
struct EWScreenInfo {
    static let Height = kScreenHeight
    static let Width = kScreenWidth
    static let navigationHeight:CGFloat = kSafeAreaTopHeight //导航高度
