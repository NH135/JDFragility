...
@class LMJDropdownMenu,MCButton;

typedef void(^seledBlock) (NSString *str);
...
- (void)dropdownMenu:(LMJDropdownMenu *)menu selectedCellNumber:(NSInteger)number str:(NSString *)str; // 当选择某个选项时调用
...
@property (nonatomic,copy) seledBlock block;
...
/**
 <#Class#>
 */
@property (nonatomic,strong) UIColor *bordrColor;
@end
